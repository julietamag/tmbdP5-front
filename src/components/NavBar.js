...
export const NavBar = () => {
  ...
  function handleLogout(e) {
    e.preventDefault();
    axios
      .post("https://tmbd-p5-front-3widubzvv-julietamag.vercel.app/api/user/logout", {
        //AxiosRequestConfig parameter
        withCredentials: true, //correct
      })
      .then(() => {
        document.cookie =
          "token=;expires=Thu, 01 Jan 1970 00:00:00 UTC;domain=https://tmbd-p5-front-3widubzvv-julietamag.vercel.app/;path=/;";
        dispatch(logoutUser());
        localStorage.clear();
        navigate("/");
      })
